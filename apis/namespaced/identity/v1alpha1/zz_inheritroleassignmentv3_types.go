...
type InheritRoleAssignmentV3InitParameters struct {
	...
	// +crossplane:generate:reference:extractor=github.com/crossplane-contrib/provider-openstack/apis/namespaced/identity/v1alpha1.ExtractDomainID()
	...
	// The role to assign.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-openstack/apis/namespaced/identity/v1alpha1.RoleV3
	...
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-openstack/apis/namespaced/identity/v1alpha1.UserV3
	// +crossplane:generate:reference:extractor=github.com/crossplane/upjet/v2/pkg/resource.ExtractResourceID()
